		...
		<div className="space-y-8">
			<div>
				...
				<p className="text-slate-600 leading-relaxed">
					We're here to help with any questions about NMTA, submissions,
					partnerships, or general inquiries. Reach out to us through any of the
					channels below.
				</p>
			</div>
			...
			{/* Department Contacts */}
			{/* <div>
				<h4 className="text-xl font-bold font-playfair text-slate-900 mb-6">
					Department Contacts
				</h4>
				<div className="space-y-4">
					{departments.map((dept, index) => {
						...
						return (
							<div
								key={index}
								className="bg-slate-50 rounded-xl p-4 hover:bg-slate-100 transition-colors duration-300"
							>
			...
			<div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
				...
				<p className="text-amber-800 text-sm leading-relaxed">
					...
					days. For urgent matters, please call our main office number.
				</p>
			</div>
		</div>
	);
