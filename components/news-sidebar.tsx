...
const featuredNews = [
	...
	},
	{
		...
		excerpt:
			"Complete guidelines for film submissions now available. Early bird deadline set for June 30, 2025.",
		date: "2024-12-10",
	...
	},
	{
		...
		excerpt:
			"Industry veterans and acclaimed filmmakers from across Africa join the NMTA jury panel.",
		date: "2024-12-05",
		category: "Jury",
	...
	},
	{
		...
		excerpt:
			"NMTA partners with Eko Convention Centre for the inaugural awards ceremony in Lagos.",
		date: "2024-12-01",
		category: "Venue",
...
export default function NewsSidebar() {
	return (
		<aside className="space-y-8 my-2">
