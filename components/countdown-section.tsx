  ...
  return (
    <section className="py-16">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-slate-900 mb-4">Awards Ceremony</h2>
        <p className="text-xl text-slate-600">
          Mark your calendars for an unforgettable evening celebrating Nigerian cinema excellence
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-amber-100 rounded-2xl p-8">
        <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start">
            ...
            <div>
              <div className="font-semibold text-slate-900">December 15, 2025</div>
          ...
          <div className="flex items-center justify-center md:justify-start">
            ...
            <div>
              <div className="font-semibold text-slate-900">Eko Convention Centre</div>
              <div className="text-slate-600">Victoria Island, Lagos</div>
            </div>
          </div>
          <div className="flex items-center justify-center md:justify-start">
            <Clock className="w-6 h-6 text-amber-600 mr-3" />
            <div>
              <div className="font-semibold text-slate-900">Red Carpet</div>
